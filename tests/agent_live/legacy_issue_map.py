...
KNOWN_ISSUES_A: tuple[LegacyItem, ...] = (
    ...
    _item("A.3", "Negated protocol must not select a family", "chain_identity", "chain_rpc", "guarded", "test_adapter_family_domain_has_no_prose_hint_interpreter"),
    ...
    _item("A.5", "Out-of-range menu answer routes semantically and keeps the contract", "opening", "coordinator", "guarded", "test_out_of_range_numbered_answer_routes_to_semantic_planner"),
    ...
    _item("A.18", "Negated family enumeration reaches Case 3", "chain_identity", "chain_rpc", "guarded", "test_adapter_family_domain_has_no_prose_hint_interpreter"),
    ...
    _item("A.25", "Numbered confirm-or-value answer", "endpoint_process", "coordinator", "guarded", "test_numbered_confirm_or_value_is_local_but_manual_value_is_reviewed"),
    ...
    _item("A.47", "Internal routing status never leaks", "opening", "orientation", "guarded", "test_current_context_catalog_does_not_leak_internal_status"),
...
REPAIR_PLAN_PHASES: tuple[LegacyItem, ...] = (
    ...
    _repair_phase(5, "Harness/ADK dependency boundary", ALL_CURRENT_GROUPS, "llm_boundary", "superseded", "test_deepseek_runtime_does_not_require_google_adk", "test_static_call_graph_rejects_retired_planner_authorities"),
